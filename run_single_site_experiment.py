#!/usr/bin/env python3
"""
Mellowtel SDK Network Analysis Tool - Single Site Long Duration Mode
Captures all network activity from Chrome browsing with extension installed.
Visits a single site for 40 minutes to observe extended Mellowtel behavior.
"""
...
class NetworkAnalyzer:
    """Main class for running the single-site long-duration network analysis experiment."""
    ...
    def load_first_site(self) -> str:
        """Load the first URL from sites.txt."""
        try:
    ...
    def visit_site(self, url: str):
        ...
        logger.info(f"\nVisiting: {url}")
        logger.info(f"Monitoring duration: {self.monitoring_duration} seconds ({self.monitoring_duration / 60} minutes)")
    ...
    def run_experiment(self):
        ...
        logger.info("=" * 70)
        logger.info("Mellowtel SDK Network Analysis Tool - Single Site Long Duration Mode")
        logger.info("=" * 70)
