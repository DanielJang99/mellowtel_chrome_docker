...
echo "[3/6] Installing Docker Buildx..."
...
echo "[4/6] Installing Buildx for user and system-wide..."
...
echo "[5/6] Installing and configuring cron..."
...
echo "[6/6] Adding cron job to run every hour..."
...
echo "Setup Complete!"
echo "========================================="
echo "Prerequisites (must be done manually before running this script):"
echo "  - System packages updated (sudo yum update -y)"
echo "  - Git installed (sudo yum install git -y)"
echo "  - Docker installed (sudo yum install docker -y)"
